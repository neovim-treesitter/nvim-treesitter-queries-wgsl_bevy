# nvim-treesitter-queries-wgsl_bevy

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-wgsl_bevy/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-wgsl_bevy/actions/workflows/validate.yml)

Neovim tree-sitter queries for **wgsl_bevy**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-wgsl_bevy",
...
- [ ] Changes are scoped to `wgsl_bevy` — do not include files for other languages
